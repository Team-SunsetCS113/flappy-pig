...
public class WeaponScript : MonoBehaviour {
      ...
      public void Attack(bool isEnemy)
      {
        if (CanAttack)
        {
          ...
          //shotTransform.rotation = Quaternion.Euler(0, 0, 0 - transform.rotation.z);
          ...
          SimpleMovementScript move = shotTransform.gameObject.GetComponent<SimpleMovementScript>();
          if (move != null)
          {
